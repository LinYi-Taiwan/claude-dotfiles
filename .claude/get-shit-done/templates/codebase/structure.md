...
- Usage: Reference from command with `@/Users/reid.lin/Desktop/repos/claude-dotfiles/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/reid.lin/Desktop/repos/claude-dotfiles/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/reid.lin/Desktop/repos/claude-dotfiles/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
