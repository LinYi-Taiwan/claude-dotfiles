...
Use template from `/Users/reid.lin/Desktop/repos/claude-dotfiles/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/reid.lin/Desktop/repos/claude-dotfiles/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/reid.lin/Desktop/repos/claude-dotfiles/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
