...
- **Global scope**: `/Users/reid.lin/Desktop/repos/claude-dotfiles/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/reid.lin/Desktop/repos/claude-dotfiles/.claude/notes/`)
...
2. Glob `/Users/reid.lin/Desktop/repos/claude-dotfiles/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/reid.lin/Desktop/repos/claude-dotfiles/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/reid.lin/Desktop/repos/claude-dotfiles/.claude/notes/` — works in any directory
